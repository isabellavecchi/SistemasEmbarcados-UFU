...
(library Library_1
	...
	(patternDef "SOT95P245X130-3N" (originalName "SOT95P245X130-3N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.662 1.465) (pt 0.662 1.465) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0.662 1.465) (pt 0.662 -1.465) (width 0.025))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.662 0.515) (pt 0.288 1.465) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "2N3904S" (originalName "2N3904S") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		...
		(attr "Description" "x")
		(attr "<Hyperlink>" "https://4donline.ihs.com/images/VipMasterIC/IC/KECC/KECC-S-A0011628560/KECC-S-A0011628560-1.pdf?hkey=EF798316E3902B6ED9A73243A3159BB0")
		(attr "<Component Height>" "1.3")
		(attr "<STEP Filename>" "2N3904S.stp")
