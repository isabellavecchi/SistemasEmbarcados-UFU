...
(library Library_1
	...
	(patternDef "CAPPM168X90N" (originalName "CAPPM168X90N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.8 0.125) (pt -0.5 0.425) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "TCM0G226M8R" (originalName "TCM0G226M8R") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		...
		(attr "<Hyperlink>" "https://fscdn.rohm.com/en/products/databook/datasheet/passive/tantalum_capacitor/tantalum_chip_capacitor/tc_m-e.pdf")
		(attr "<Component Height>" "0.9")
		(attr "<STEP Filename>" "TCM0G226M8R.stp")
